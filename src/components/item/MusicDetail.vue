  ...
  <div class="detailTop">
    <div class="detailTopLeft">
      ...
      <div class="leftMarquee">
        ...
        <span v-for="item in musicList.artists" :key="item">
          {{ item.name }}/
        </span>
...
export default {
  ...
  mounted() {
    ...
    this.addDuration()
    console.log("该页面的歌曲id",this.playList[this.playListIndex].id)
    //this.updateisBottomNav()
  },
  // destroyed() {
  //   this.updateisBottomNav()
  // },
  ...
  methods: {
    ...
    ...mapMutations(["updateDetailShow", "updatePlayListIndex","updateisBottomNav"]),
  },
  watch: {
