...
export default createStore({
  ...
  mutations: {
    updateisBottomNav: function (state, value) {
      state.isBottomNav = !state.isBottomNav
      console.log("是否显示",state.isBottomNav)
    },
    ...
    updateLyricList:function(state,value){
      ...
      console.log("歌词**",state.lyricList)
    },
